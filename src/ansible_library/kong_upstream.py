...
description:
    - Manage Kong Upstreams in their main CRUD operations. See U(https://getkong.org/docs/0.10.x/admin-api/) for details.
...
def main():
  module = AnsibleModule(
        argument_spec = dict(
            ...
            slots=dict(required=False, type='str'),
            orderlist=dict(required=False, type='str'),
