...
description:
    - Manage Kong certificates in their main CRUD operations. See U(https://getkong.org/docs/0.10.x/admin-api/) for details.
...
def main():
  ...
  try:
    ...
    if state == "info":
       response = api.info_certificate(data.get('id'))
